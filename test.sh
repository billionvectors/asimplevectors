...
echo
rpc 21001/api/space/spacename
echo "Read from node 2"
echo
rpc 21002/api/space/spacename
echo "Read from node 3"
echo
rpc 21003/api/space/spacename
...
sleep 1
echo
rpc 21002/api/space '{"Set":{"key":"foo","value":"badger"}}'
sleep 1
echo "Data written"
sleep 1
...
sleep 1
echo
rpc 21003/api/space '{"Set":{"key":"foo","value":"badger"}}'
sleep 1
echo "Data written"
sleep 1
...
echo "Read from node 3"
echo
rpc 21003/api/debug/read  '"space"'
sleep 1
...
echo "Read from node 1"
echo
rpc 21001/api/debug/read  '"space"'
sleep 1
