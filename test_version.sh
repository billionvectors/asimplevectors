...
echo "Create version on leader"
sleep 1
echo
rpc 21001/api/space/spacename/version  \
'{
    "name": "version1",
...
echo "Get version1 node 1"
rpc 21001/api/space/spacename/version/version1/by-name
sleep 1

echo "Get version1 node 2"
rpc 21002/api/space/spacename/version/version1/by-name
sleep 1

echo "Get version1 node 3"
rpc 21003/api/space/spacename/version/version1/by-name
sleep 1

echo "Get default version node 1"
rpc 21001/api/space/spacename/version/default
sleep 1

echo "Get default version node 2"
rpc 21002/api/space/spacename/version/default
sleep 1

echo "Get default version node 3"
rpc 21003/api/space/spacename/version/default
sleep 1

echo "Get version list node 1"
rpc 21001/api/space/spacename/version/list
sleep 1

echo "Get version list node 2"
rpc 21002/api/space/spacename/version/list
sleep 1

echo "Get version list node 3"
rpc 21003/api/space/spacename/version/list
sleep 1
